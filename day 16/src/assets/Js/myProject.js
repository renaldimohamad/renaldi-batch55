...
//     document.getElementById("contens").innerHTML += `
//     <div  class="content">
//     <a href="detailProject.html" style="text-decoration: none; color: black;">
//     <img src="${project[index].Image}" alt="" >
//     <p class="title-content"> Dumbways Mobile App - 2024</p>
//     <p>${project[index].names}</p>
//     <p class="duration-date"> durasi  ${project[index].durationDate} Hari</p>
//     <p class="text-style">tes tes</p>
...
//     <button class="button-style" ${index} >edit</button>
//     <button class="button-style" onclick="deleteData(${index})">delete</button>
// </div>
// </div>  `;
//   }
// }
